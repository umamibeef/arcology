/*  r_soft.h -- the reference rasteriser.
 *
 ...
 *  original's order and never paints: see r_sweep. */
typedef enum
{
...
int  r_sweep(const RAtlas *a, const RCity *c, const RSoftOpts *o,
...
/*  Where the --focus tile landed, valid after r_soft_render.  Returns 0
