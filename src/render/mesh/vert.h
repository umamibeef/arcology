 ...
 *  both sides need it and neither should own it: it lived in gpu.h, which
 *  made mesh.h include gpu.h -- the geometry subsystem depending on the
 *  device that happens to draw it.  The arrow now points from both at this. */
#ifndef R_MESHVERT_H
#define R_MESHVERT_H
