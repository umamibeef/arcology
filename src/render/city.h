...
/*  Altitude, out of ALTM.  The word holds two heights: the land in bits 0
 *  to 4 and the water table in bits 5 to 9.  Which one a tile stands at is
 *  XTER's business -- below 0x10 it is dry and reads the land, at or above
 *  it the surface is water and reads the table.  This was written out three
 *  times, in the sweep, in the mesh's tile code and in the app's centring
 *  tool, each time as raw shifts and masks.  The layout belongs next to the
 *  type it decodes. */
