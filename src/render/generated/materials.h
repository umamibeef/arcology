...
#define MAT_SURFACE    6.0f   /* a levelled pad */
#define MAT_ROAD       7.0f   /* a road strip on the surface */
#define MAT_PROP       8.0f   /* street furniture: a pole, a sign, a box */
#define MAT_LAMP       9.0f   /* a lamp's or a signal's lit face */
#define MAT_ZEBRA      10.0f  /* a crossing's painted bands */
#define MAT_RAIL       11.0f  /* a railway's track bed */
#define MAT_SKIRT      12.0f  /* a vehicle's clipped skirt */
#define MAT_WALK       13.0f  /* a footway */
#define MAT_RAIL_X     14.0f  /* a level crossing's panel bed */
#define MAT_VEHICLE    15.0f  /* a car's body */
#define MAT_XPANEL     16.0f  /* a crossing panel */
#define MAT_XAPPROACH  17.0f  /* a crossing's approach markings */
#define MAT_PIER       18.0f  /* a viaduct's bent and its cast concrete */
#define MAT_HIWAY      19.0f  /* a freeway deck */
#define MAT_HIWAY_LANE 19.3f  /* a ramp lane, drawn as the deck's outer lane */
