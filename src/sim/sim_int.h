 ...
 *  phases are coupled, and the list is meant to stay readable.
 */
#ifndef SIM_INT_H
#define SIM_INT_H
...
/*  The eight neighbours in the order the original walks them, A5-0x4F4E
...
/*  sim_queue.c -- the shared 512-entry ring.  queueReset $21DD4,
 *  queuePush $21DF2, queuePop $21E3A, queuePopBack $21E66,
 *  queuePeekBack $21E96. */
void q_reset(void);
